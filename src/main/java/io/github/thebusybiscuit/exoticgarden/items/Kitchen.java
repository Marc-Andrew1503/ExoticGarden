...
public class Kitchen extends MultiBlockMachine {
    ...
    public Kitchen(ExoticGarden plugin, ItemGroup itemGroup) {
        super(itemGroup, new SlimefunItemStack("KITCHEN", Material.CAULDRON, "&eKitchen", "", "&a&oYou can make a bunch of different yummies here!", "&a&oThe result goes in the Furnace output slot"), new ItemStack[] { CustomItemStack.create(new ItemStack(Material.BRICK_STAIRS), "&oBrick Stairs (upside down)"), CustomItemStack.create(new ItemStack(Material.BRICK_STAIRS), "&oBrick Stairs (upside down)"), new ItemStack(Material.BRICKS), new ItemStack(Material.STONE_PRESSURE_PLATE), new ItemStack(Material.IRON_TRAPDOOR), new ItemStack(Material.BOOKSHELF), new ItemStack(Material.FURNACE), new ItemStack(Material.DISPENSER), new ItemStack(Material.CRAFTING_TABLE) }, new ItemStack[0], BlockFace.SELF);
